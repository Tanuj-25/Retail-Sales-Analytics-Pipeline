...
file_location = "/Users/tanuj.rana/Desktop/Project_DE/All_files/sales_data_to_S3/"
if not os.path.exists(file_location):
    os.makedirs(file_location)

input_date_str = "2025-12-06"
input_date = datetime.strptime(input_date_str, "%Y-%m-%d")

csv_file_path = os.path.join(file_location, f"sales_data_4.csv")
